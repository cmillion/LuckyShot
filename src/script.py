...
filenames = {'Wesley':['../../../Lucky/Wesley Uranus Storm Data New/20141002/',
                      ['20141002_131357_R650.ser','20141002_144929_R650.ser',
             ...
             'Delcroix':[('../../../Lucky/Delcroix Uranus Storm Data/'
                                        'uranus_20141003-04_ir685_PicDuMidi/'),
                         ['ir685_1/2014-10-03-2242_5-MD-IR685-8.ser',
...
for i in range(header['FrameCount']-1):
    frame=ser.readframe(WesleyRelpath+WesleyFiles[1],i,header=header)
    print i
    img+=frame
